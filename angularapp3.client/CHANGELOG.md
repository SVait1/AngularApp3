...
- Создайте проект Angular с помощью ng: `ng new angularapp3.client --defaults --skip-install --skip-git --no-standalone `.
...
- Создание файла проекта (`angularapp3.client.esproj`).
